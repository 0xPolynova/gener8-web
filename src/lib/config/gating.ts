  ...
  tiers: [
    {
      ...
      name: "Access",
      label: "Access",
      minimumBalance: env.minBalance,
      dailyGenerations: env.dailyGenerations,
    ...
    },
    {
      ...
      name: "Creator",
      label: "Creator",
      minimumBalance: env.minBalance * 5,
      dailyGenerations: env.dailyGenerations * 4,
    ...
    },
    {
      ...
      name: "Studio",
      label: "Studio",
      minimumBalance: env.minBalance * 25,
      dailyGenerations: env.dailyGenerations * 20,
