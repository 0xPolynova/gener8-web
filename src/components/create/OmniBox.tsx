...
export function OmniBox() {
  ...
  useEffect(() => {
    const handler = (e: Event) => {
      const { videoUrl, duration, title, id } = (e as CustomEvent<RemixVideo & { videoUrl: string }>).detail;
      ...
      <div className="omni-box relative rounded-2xl bg-ink/92 backdrop-blur-xl overflow-hidden shadow-2xl">
        ...
        {remix && (
          <div className="px-3 pb-1">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-yellow/30 bg-yellow/10 px-2.5 py-0.5 text-[11px] font-medium text-yellow">
